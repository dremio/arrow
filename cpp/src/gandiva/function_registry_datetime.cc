...
std::vector<NativeFunction> GetDateTimeFunctionRegistry() {
  static std::vector<NativeFunction> date_time_fn_registry_ = {
      ...
      NativeFunction("to_char", {}, DataTypeVector{timestamp(), utf8()}, utf8(),
                     kResultNullInternal, "gdv_fn_to_char_timestamp_utf8",
                     NativeFunction::kNeedsContext |
                         NativeFunction::kNeedsFunctionHolder |
                         NativeFunction::kCanReturnErrors),

      NativeFunction("date_format", {}, DataTypeVector{timestamp(), utf8()}, utf8(),
                     kResultNullInternal, "gdv_fn_date_format_timestamp_utf8",
                     NativeFunction::kNeedsContext |
                         NativeFunction::kNeedsFunctionHolder |
                         NativeFunction::kCanReturnErrors),
