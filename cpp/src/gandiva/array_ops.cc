...
Type* array_remove_template(int64_t context_ptr, const Type* entry_buf, int32_t entry_len,
                            const int32_t* entry_validity, bool combined_row_validity,
                            Type remove_data, bool remove_data_valid, int64_t loop_var,
  ...
  for (int i = 0; i < entry_len; i++) {
    ...
    } else if (!arrow::bit_util::GetBit(
                   reinterpret_cast<const uint8_t*>(entry_validityAdjusted),
                   validityBitIndex + i)) {
...
template <typename Type>
bool array_contains_template(const Type* entry_buf, int32_t entry_len,
                             const int32_t* entry_validity, bool combined_row_validity,
...
bool array_int32_contains_int32(int64_t context_ptr, const int32_t* entry_buf,
                                ...
                                bool contains_data_valid, int64_t loop_var,
                                int64_t validity_index_var, bool* valid_row) {
  return array_contains_template<int32_t>(
      entry_buf, entry_len, entry_validity, combined_row_validity, contains_data,
      contains_data_valid, loop_var, validity_index_var, valid_row);
}
...
bool array_int64_contains_int64(int64_t context_ptr, const int64_t* entry_buf,
                                ...
                                bool contains_data_valid, int64_t loop_var,
                                int64_t validity_index_var, bool* valid_row) {
  return array_contains_template<int64_t>(
      entry_buf, entry_len, entry_validity, combined_row_validity, contains_data,
      contains_data_valid, loop_var, validity_index_var, valid_row);
}
...
bool array_float32_contains_float32(int64_t context_ptr, const float* entry_buf,
                                    ...
                                    bool contains_data_valid, int64_t loop_var,
                                    int64_t validity_index_var, bool* valid_row) {
  return array_contains_template<float>(
      entry_buf, entry_len, entry_validity, combined_row_validity, contains_data,
      contains_data_valid, loop_var, validity_index_var, valid_row);
}
...
bool array_float64_contains_float64(int64_t context_ptr, const double* entry_buf,
                                    ...
                                    bool contains_data_valid, int64_t loop_var,
                                    int64_t validity_index_var, bool* valid_row) {
  return array_contains_template<double>(
      entry_buf, entry_len, entry_validity, combined_row_validity, contains_data,
      contains_data_valid, loop_var, validity_index_var, valid_row);
}
...
int32_t* array_int32_remove(int64_t context_ptr, const int32_t* entry_buf,
                            ...
                            bool remove_data_valid, int64_t loop_var,
                            int64_t validity_index_var, bool* valid_row, int32_t* out_len,
                            int32_t** valid_ptr) {
  return array_remove_template<int32_t>(context_ptr, entry_buf, entry_len, entry_validity,
                                        combined_row_validity, remove_data,
                                        remove_data_valid, loop_var, validity_index_var,
...
int64_t* array_int64_remove(int64_t context_ptr, const int64_t* entry_buf,
                            ...
                            int64_t validity_index_var, bool* valid_row, int32_t* out_len,
                            int32_t** valid_ptr) {
  return array_remove_template<int64_t>(context_ptr, entry_buf, entry_len, entry_validity,
                                        combined_row_validity, remove_data,
                                        remove_data_valid, loop_var, validity_index_var,
                                        valid_row, out_len, valid_ptr);
}
...
float* array_float32_remove(int64_t context_ptr, const float* entry_buf,
                            ...
                            int64_t validity_index_var, bool* valid_row, int32_t* out_len,
                            int32_t** valid_ptr) {
  return array_remove_template<float>(context_ptr, entry_buf, entry_len, entry_validity,
                                      combined_row_validity, remove_data,
                                      remove_data_valid, loop_var, validity_index_var,
                                      valid_row, out_len, valid_ptr);
}
...
double* array_float64_remove(int64_t context_ptr, const double* entry_buf,
  ...
  return array_remove_template<double>(context_ptr, entry_buf, entry_len, entry_validity,
                                       combined_row_validity, remove_data,
                                       remove_data_valid, loop_var, validity_index_var,
                                       valid_row, out_len, valid_ptr);
}
...
arrow::Status ExportedArrayFunctions::AddMappings(Engine* engine) const {
  ...
  engine->AddGlobalMappingForFunc(
      "array_float32_contains_float32", types->i1_type() /*return_type*/, args,
  ...
  engine->AddGlobalMappingForFunc(
      "array_float64_contains_float64", types->i1_type() /*return_type*/, args,
  ...
  engine->AddGlobalMappingForFunc("array_int32_remove", types->i32_ptr_type(), args,
  ...
  engine->AddGlobalMappingForFunc("array_int64_remove", types->i64_ptr_type(), args,
  ...
  engine->AddGlobalMappingForFunc("array_float32_remove", types->float_ptr_type(), args,
  ...
  engine->AddGlobalMappingForFunc("array_float64_remove", types->double_ptr_type(), args,
