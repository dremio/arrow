...
bool similar_utf8_utf8(const char* data, gdv_int32 data_len, const char* pattern,
                       gdv_int32 pattern_len);
bool similar_to_utf8_utf8(const char* data, gdv_int32 data_len, const char* pattern,
                          gdv_int32 pattern_len);
