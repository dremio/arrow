...
public class TimeMicroReaderImpl extends AbstractFieldReader {
  ...
  public TimeMicroReaderImpl(TimeMicroVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(TimeMicroWriter writer){
    TimeMicroWriterImpl impl = (TimeMicroWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, StructWriter writer){
    TimeMicroWriterImpl impl = (TimeMicroWriterImpl) writer.timeMicro(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
