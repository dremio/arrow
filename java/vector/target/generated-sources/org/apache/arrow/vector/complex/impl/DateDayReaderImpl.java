...
public class DateDayReaderImpl extends AbstractFieldReader {
  
  private final DateDayVector vector;
  
  public DateDayReaderImpl(DateDayVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(DateDayWriter writer){
    DateDayWriterImpl impl = (DateDayWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, StructWriter writer){
    DateDayWriterImpl impl = (DateDayWriterImpl) writer.dateDay(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
