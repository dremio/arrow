...
public class TimeStampMilliReaderImpl extends AbstractFieldReader {
  
  private final TimeStampMilliVector vector;
  
  public TimeStampMilliReaderImpl(TimeStampMilliVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(TimeStampMilliWriter writer){
    TimeStampMilliWriterImpl impl = (TimeStampMilliWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, StructWriter writer){
    TimeStampMilliWriterImpl impl = (TimeStampMilliWriterImpl) writer.timeStampMilli(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
