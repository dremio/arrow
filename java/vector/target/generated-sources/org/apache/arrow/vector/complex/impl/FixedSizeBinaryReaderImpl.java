...
public class FixedSizeBinaryReaderImpl extends AbstractFieldReader {
  
  private final FixedSizeBinaryVector vector;
  
  public FixedSizeBinaryReaderImpl(FixedSizeBinaryVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(FixedSizeBinaryWriter writer){
    FixedSizeBinaryWriterImpl impl = (FixedSizeBinaryWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, StructWriter writer){
    FixedSizeBinaryWriterImpl impl = (FixedSizeBinaryWriterImpl) writer.fixedSizeBinary(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
