...
public class LargeVarBinaryReaderImpl extends AbstractFieldReader {
  
  private final LargeVarBinaryVector vector;
  
  public LargeVarBinaryReaderImpl(LargeVarBinaryVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(LargeVarBinaryWriter writer){
    LargeVarBinaryWriterImpl impl = (LargeVarBinaryWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, StructWriter writer){
    LargeVarBinaryWriterImpl impl = (LargeVarBinaryWriterImpl) writer.largeVarBinary(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
