...
public class TimeStampNanoTZReaderImpl extends AbstractFieldReader {
  
  private final TimeStampNanoTZVector vector;
  
  public TimeStampNanoTZReaderImpl(TimeStampNanoTZVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(TimeStampNanoTZWriter writer){
    TimeStampNanoTZWriterImpl impl = (TimeStampNanoTZWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, StructWriter writer){
    TimeStampNanoTZWriterImpl impl = (TimeStampNanoTZWriterImpl) writer.timeStampNanoTZ(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
