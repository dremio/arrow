...
public class NullableIntervalMonthDayNanoHolderReaderImpl extends AbstractFieldReader {
  ...
  public void read(IntervalMonthDayNanoHolder h) {
    h.months = holder.months;
    h.days = holder.days;
    h.nanoseconds = holder.nanoseconds;
  }
