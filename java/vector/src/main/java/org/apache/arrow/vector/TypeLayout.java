...
public class TypeLayout {
  ...
  /**
   * Returns the types of each buffer for this layout. A layout can consist of multiple buffers for
   * example a validity bitmap buffer, a value buffer or an offset buffer.
   */
